<template>
    <div class="container my-5">
        ...
        <div class="row my-5">
            <div class="col-lg-8 col-sm-12 border border-2 border-light-subtle rounded-5 p-1 "
                v-if="carts && carts.length > 0">
                <table class="table table-border p-2" style="width: 100%">
                    <tbody>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class=" ms-2">
                                        ...
                                        <span class="fw-medium d-block text-muted fs-7">color: {{ cart.selectedColor ||
                                            'Default' }}</span>
                                        <span class="fw-bold d-block text-muted fs-6">size: {{ cart.selectedSize ||
                                            'Default' }}
                                        </span>
